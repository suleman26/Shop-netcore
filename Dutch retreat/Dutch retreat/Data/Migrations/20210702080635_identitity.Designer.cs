...
namespace dutch_retreat.Migrations
{
    ...
    [Migration("20210702080635_identitity")]
    partial class identitity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 79,
                            OrderDate = new DateTime(2021, 7, 2, 0, 0, 0, 0, DateTimeKind.Local),
                            OrderNumber = "78"
                        });
                });
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArtId = "SK-A-2351",
                            Artist = "Apple",
                            ArtistBirthDate = new DateTime(2021, 7, 2, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("dutch_retreat.Data.Entities.StoreUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("dutch_retreat.Data.Entities.StoreUser", null)
                        .WithMany()
